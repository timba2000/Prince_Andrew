...
**1. ScubaDownUnder Dive Site Reviews:**
   ...
   - **Format:** All completed Scuba Down Under dive site articles will be combined into a single Markdown file named `SDU_dive_sites.md` located in the `dive_site_articles/` directory.
